# GENESIS FieldShield demo script (under three minutes)
...
Show the operating reality: 640 responses, four LGAs, 16 research assistants, mixed methods, unreliable internet, childbirth continuity risk, and KoboToolbox already handling questionnaires.

"GENESIS discovered that the real need is not another survey form. It is coordination, quality control and continuity."

Select **Shape the FieldShield blueprint**.
...
"GENESIS orders work by dependency, not by visibility."
...
## 2:45-2:58 - OpenAI and Codex

"GENESIS keeps the OpenAI Responses API integration ready for funded live analysis, with schema and semantic validation. Codex built and verified this implementation through typed contracts, unit tests, coverage, production compilation and desktop and mobile browser tests."

## Close

"GENESIS does not merely help people code faster. It helps them discover what should be built, what could destroy it and the right order in which to create it."
